...
export default function MobileHeader() {
  ...
  return (
    ...
    >
      <header className="w-full flex flex-col backdrop-blur-lg shadow-sm ">
        <div className="w-full flex justify-between p-4">
          ...
          <button
            ...
            className="btn btn-sm btn-accent flex-col"
      ...
      <div
        className={`nav-menu w-full bg-white shadow-sm flex flex-col transition-all duration-300 ${
          isOpen
            ? "opacity-100 translate-y-0"
            : "pointers-event-none opacity-0 -translate-y-2"
        }`}
      >
